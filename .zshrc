...
echo "Welcome,"
date +"It's %c."
echo "${GREEN}This is zsh version:"
zsh --version
...
# update aliases
# ohmyzsh update is `omz update`
alias update_p10k="git -C $ZSH_CUSTOM/themes/powerlevel10k pull"
alias update_sys="sudo apt-get update -y && sudo apt-get upgrade -y"
